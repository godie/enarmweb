...
function GoogleSocialButton({ onClick }) {
  return (
    ...
    >
      ...
      <span className='v2-text-semibold'>Registrarse con Google</span>
    </button>
  );
}

// Facebook Signup Button Component
function FacebookSocialButton({ onClick }) {
  return (
    ...
    >
      ...
      <span className='v2-text-semibold'>Registrarse con Facebook</span>
    </button>
  );
}
...
const V2Signup = () => {
  ...
  const handleGoogleResponse = useCallback(async (response) => {
    ...
    try {
      ...
      alertError('Error', 'No se pudo registrar con Google');
    } finally {
      setLoading(false);
    }
  }, [history]);

  // Facebook Signup Handler (no useCallback to avoid stale closure)
  ...
  const handleFacebookResponse = useCallback(async (response) => {
    ...
    try {
      ...
      alertError('Error', 'No se pudo registrar con Facebook');
    } finally {
      setLoading(false);
    }
  }, [history]);
    ...
    <main className='v2-app-container v2-page-centered'>
      <div className='v2-card v2-page-centered-content-wide'>
        ...
        <div className='v2-flex-col v2-gap-12 v2-mb-24'>
          <GoogleSocialButton onClick={handleGoogleSignup} />
          <FacebookSocialButton onClick={handleFacebookSignup} />
        </div>
        ...
        <form onSubmit={handleSignup} className='v2-flex-col v2-gap-16 v2-text-left'>
          <div className='v2-input-outlined'>
            <label htmlFor='name'>Nombre Completo</label>
            <i className='material-icons v2-input-prefix-icon' aria-hidden='true'>person</i>
            <input
              id='name'
              type='text'
              name='name'
          ...
          <div className='v2-input-outlined'>
            ...
            <i className='material-icons v2-input-prefix-icon' aria-hidden='true'>badge</i>
            <input
              id='username'
              type='text'
              name='username'
          ...
          <button type='submit' className='v2-btn-filled v2-btn-full v2-btn-h-56 v2-mt-8' disabled={loading}>
            {loading ? (
