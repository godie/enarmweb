...
const V2SessionSummary = () => {
  ...
  useEffect(() => {
    const handleKeyDown = (e) => {
      ...
      if (key === 'enter') {
        // Only trigger if not already on a button to avoid double activation
        ...
        if (totalQuestions - correctAnswers > 0) {
    ...
    <div className='v2-page-medium v2-text-center'>
      ...
      <div className='v2-flex v2-gap-16 v2-flex-justify-center v2-flex-wrap'>
        <button 
          ...
          aria-label='Volver al inicio (atajo: tecla I)'
          title='Atajo: I'
        >
        ...
        {totalQuestions - correctAnswers > 0 && (
          <button 
            ...
            style={{ padding: '0 32px' }}
            aria-label='Revisar errores (atajo: tecla R)'
            title='Atajo: R'
          >
        ...
        <button 
          ...
          style={{ padding: '0 32px' }}
          aria-label='Nueva sesión de práctica (atajo: tecla Enter)'
          title='Atajo: Enter'
        >
